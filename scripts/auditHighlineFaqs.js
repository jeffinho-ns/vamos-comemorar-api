...
Como a IA usa isso:
1) Pergunte ANTES qual área o cliente quer (Deck - Mesas, Bar Central, Rooftop).
...
2) **Bloco 2: pergunte a ÁREA preferida** (Deck - Mesas, Bar Central - Bistrôs de Espera, Rooftop). Se o cliente não souber, ofereça sua sugestão pegando consultar_areas_mesa_reserva (área recomendada para a quantidade de pessoas naquela data).
...
"Show, {data} às {horário} pra {N} pessoas tem vaga. Pra onde você prefere — Deck - Mesas, Bar Central ou Rooftop? Se for um grupo grande, a gente combina mesas próximas pra todo mundo ficar junto numa única reserva."`,
  },
];
