...
try {
  require('./utils/agendaRealtime').attachAgendaRealtime(io);
} catch (e) {
...
app.use('/api/org', require('./routes/orgTeam')(pool));
app.use('/api/establishments', require('./routes/establishmentRules')(pool));
